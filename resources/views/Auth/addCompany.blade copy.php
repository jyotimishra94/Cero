                                    ...
                                    <div class="stepper stepper-links d-flex flex-column" id="kt_stepper_project" data-kt-stepper="true">                                   
                                        ...
                                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold" role="tablist">
                                            ...
                                            <li class="nav-item mt-2" role="presentation">
                                                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ $step == 0 ? 'active' : '' }}" data-bs-toggle="tab" href="{{ $step == 0 ? '#kt_tab_pane_1' : '#' }}" aria-selected="true" role="company">Add Company</a>
                                            </li>
                                            <li class="nav-item mt-2" role="presentation">

                                                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ $step == 1 ? 'active' : '' }}" <?php if (!empty($company->company_id)) { ?> data-bs-toggle="tab" href="{{ $step == 1 ? '#kt_tab_pane_2' : '#' }}" aria-selected="false" tabindex="-1" role="experience" <?php } ?>>Add Clients</a>
                                            ...
                                            <li class="nav-item mt-2" role="presentation">
                                                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ $step == 2 ? 'active' : '' }}" data-bs-toggle="tab" href="{{ $step == 2 ? '#kt_tab_pane_3' : '#' }}" aria-selected="false" tabindex="-1" role="products">Add Services | Products</a>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade  {{ $step == 0 ? 'active show' : 'hide' }}" id="kt_tab_pane_1" role="tabpanel">
                                                ...
                                                <div class="current" data-kt-stepper-element="content">
                                                    <!--begin::Wrapper-->
                                                    <div class="w-100">
                                                        <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" id="formAddCompany" method="post" action="{{ route('companies.add') }}" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_name" placeholder="" value="">
                                                            </div>
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg form-control-solid" name="team_size" placeholder="" value="">
                                                            </div>
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <input type="url" class="form-control form-control-lg form-control-solid" name="official_website" placeholder="" value="">
                                                            </div>
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg form-control-solid" name="pan_number" placeholder="" value="">
                                                            </div>
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg form-control-solid" name="gst_number" placeholder="" value="">
                                                            </div>
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <div class="input-group">
                                                                    <!-- Year Input -->
                                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="experience_in_year" placeholder="Years" value="">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="experience_value" placeholder="Value" value="">


                                                                    <select class="form-select form-select-lg form-select-solid" name="experience_unit">
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg form-control-solid" name="specialization" placeholder="" value="">
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="min_project_amount" placeholder="Enter amount" value="">
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="max_project_amount" placeholder="Enter amount" value="">
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                ...
                                                                <button type="submit" id="submitAddCompany" name="submit" class="btn btn-success">Save</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <!--end::Wrapper-->
                                            ...
                                            <div class="tab-pane fade {{ $step == 1 ? 'active show' : 'hide' }}" id="kt_tab_pane_2" role="tabpanel">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{$company->official_website}}</td>
                                                ...
                                                <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" id="formAddClient" method="post" action="{{ route('addclient.post') }}" novalidate="novalidate" id="kt_modal_create_campaign_stepper_form">
                                                    @csrf
                                                    <!--begin::Step 2-->
                                                    <div data-kt-stepper-element="content" class="current">
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                                <button type="Submit" id="submitAddClient" class="btn btn-success">Continue..</button>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade {{ $step == 2 ? 'active show' : 'hide' }}" id="kt_tab_pane_3" role="tabpanel">
                                                ...
                                                <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" id="formAddServices" method="POST" action="{{ route('addServices') }}" enctype="multipart/form-data">
                                                    <!-- Fields for Services -->
                                                    @csrf
                                                    <div id="servicesFields" style="display: none;">
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="required form-label mb-3">Services Categories</label>
                                                        ...
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="required form-label mb-3">Services Sub Categories</label>
                                                        ...
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <button type="Submit" id="submitAddService" class="btn btn-success">Add</button>
                                                        </div>
                                                        <!-- Add other fields for Services here -->
                                                    </div>
                                                </form>

                                                <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" id="formAddProduct" method="POST" action="{{ route('addProducts') }}" enctype="multipart/form-data">
                                                    <!-- Fields for Products -->
                                                    @csrf
                                                    <div id="productsFields" style="display: none;">
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="required form-label mb-3">Product Categories</label>
                                                        ...
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="required form-label mb-3">Product Sub Categories</label>
                                                        ...
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="required form-label mb-3">Product Name</label>
                                                            <input type="text" class="form-control form-control-lg form-control-solid" name="product_desc" placeholder="" value="">
                                                        </div>
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="required form-label mb-3">Product Description</label>
                                                            <textarea class="form-control form-control-lg form-control-solid" name="description" placeholder=""></textarea>
                                                        </div>
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="required form-label mb-3">Product Certifications</label>
                                                            <input type="file" class="form-control form-control-lg form-control-solid" name="certifications" accept=".pdf, .doc, .docx" />
                                                        </div>
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <label class="form-label mb-3"> Tentative Cost [per unit]</label>
                                                            <div class="input-group">`
                                                        ...
                                                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                                            <button type="submit" id="submitAddProduct" name="submit" class="btn btn-success">Save</button>
                                                        </div>

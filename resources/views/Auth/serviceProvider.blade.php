				...
				<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
					<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
						<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
							...
							<form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('registerServiceProvider') }}">
								@csrf
								<div class="text-center mb-11">
									<h1 class="text-dark fw-bolder mb-3">Service Provider Registration</h1>
								</div>
								<div id="step1">
									<div class="row">
										<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="fv-row mb-8 fv-plugins-icon-container">
												<!--begin::phone-->
												<input type="text" placeholder="Phone No." value="{{ old('phone') }}" name="phone" autocomplete="off" class="form-control bg-transparent">
												<!--end::phone-->
												<div class="fv-plugins-message-container invalid-feedback"></div>
												@if ($errors->has('phone'))
									...
									<div class="row">
										<div class="fv-row mb-8 fv-plugins-icon-container">
											<input type="text" placeholder="Designation" value="{{ old('designation') }}" name="designation" autocomplete="off" class="form-control bg-transparent">
											<div class="fv-plugins-message-container invalid-feedback"></div>
											@if ($errors->has('designation'))
											<div class="fv-plugins-message-container invalid-feedback">{{ $errors->first('designation') }}</div>
											@endif
										</div>

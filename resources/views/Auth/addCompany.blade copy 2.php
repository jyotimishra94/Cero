                                    ...
                                    <div class="stepper stepper-links d-flex flex-column" id="kt_stepper_project" data-kt-stepper="true">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade  {{ $step == 0 ? 'active show' : 'hide' }}" id="kt_tab_pane_1" role="tabpanel">
                                                ...
                                                <div class="current" data-kt-stepper-element="content">
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" method="post" action="{{ route('companies.add') }}" enctype="multipart/form-data">
                                                            @csrf
                                            ...
                                            <div class="tab-pane fade {{ $step == 1 ? 'active show' : 'hide' }}" id="kt_tab_pane_2" role="tabpanel">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="card-title" style="text-align: center;">Client Details</h1>
                                                        <table class="table table-bordered-navy"> <!-- Add the custom class to the table -->
                                                            <thead>
                                                                <tr>
                                                                    <th>#</th>
                                                                    <th>Client Name</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>{{$experience->client_experience_id}}</td>
                                                                    <td>{{$experience->client_name}}</td>
                                                                    <td>{{$experience->project_title}}</td>
                                                                    <td>{{$experience->description}}</td>
                                                                    <td>{{$experience->project_size}}</td>
                                                                    <td>

                                                                        <button type="button" class="btn btn-primary edit-button" data-exp-id="{{$experience->client_experience_id}}" data-bs-toggle="modal" data-bs-target="#kt_modal_1">Edit</button>
                                                                        <button type="button" class="btn btn-danger delete-button" data-exp-id="{{$experience->client_experience_id}}">Delete</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" method="PUT" action="">
                    @csrf

                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="card">
                                <!--begin::Card body-->
                                <div class="card-body">
                                    <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="/submit-answer">
                                        <select class="form-select form-select-lg form-select-solid" name="anyTopic" id="selectTopic" onchange="fetchQuestions(this.value)">
                                            <option value="">-----Select----</option>
                                            @foreach ($survey_topics as $survey_topics)
                                            <option value="{{ $survey_topics->survey_topics_id;}}">{{ $survey_topics->name; }}</option>
                                            @endforeach
                                        </select>
